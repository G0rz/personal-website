...
const Page = () => {
    ...
    return (
        <div className="relative flex flex-wrap w-[90vw] p-[10vh] min-h-screen justify-start items-start">
            <Link href="/" className="absolute top-8 left-8">Go Home</Link>
            <GlobalDrawer header="Pablo Marte - asdasda" isOpen={isOpen} onOpenChange={onOpenChange} onOpen={onOpen}>
                <p>Problem/Goal</p>
